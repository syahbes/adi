    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Image
              source={require("@/assets/images/car/elements24PxIconsPlaceHolderImage2.png")}
        ...
        <View style={styles.rowImageAndText}>
          ...
          <View style={styles.rowImageCircleContainer}>
            <Image
              source={require("@/assets/images/car/elements24PxIconsCar.png")}
        ...
        <View style={styles.rowImageAndText}>
          ...
          <View style={styles.rowImageCircleContainer}>
            <Image
              source={require("@/assets/images/car/elements24PxIconsPin.png")}
              style={styles.rowImageCircle}
            />
          </View>
        </View>
